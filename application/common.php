...
/**
 * [curl_post_contents description]
 * @Author   Jerry
 * @DateTime 2017-09-06T18:27:24+0800
 * @Example  eg:
 * @param    string                   $url   [请求地址]
 * @param    string                   $param [参数，字符型，可以为JSON]
 * @return   [type]                          [description]
 */
function curl_post_contents($url = '', $param = ''){
        ...
        if(!empty($param)){
            ...
            curl_setopt($curl,CURLOPT_POSTFIELDS,$param);//需要要传送的内容
        }
       curl_setopt($curl, CURLOPT_RETURNTRANSFER, TRUE);
...
/**
 * [curl_multi description]
 * @Author   Jerry
 * @DateTime 2017-09-06T18:51:05+0800
 * @Example  eg:
