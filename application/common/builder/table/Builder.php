                ...
                if (!$_replace_button) {
                    foreach ($this->_vars['right_buttons'] as $button_type => $button) {
                        ...
                        $button['attribute'] = $this->compileHtmlAttr($button);
                         $row['right_button'] .= '<a '.$button['attribute'].' data-toggle="tooltip"><i class="'.$button['icon'].'" style="margin-right:3px;"></i>'.$button['html'].'</a> ';
                    }
                ...
                foreach ($this->_vars['columns'] as $column) {
                    ...
                    switch ($column['type']) {
                        ...
                        case 'picture': // 单张图片
                            ...
                            break;
                        case 'picture_path': // 单张图片
                            if($row[$column['name']]){
                              $row[$column['name']] = '<a href="'.$row[$column['name']].'" target="_blank" title="'.$row[$column['name']].'"><img class="image" src="'.$row[$column['name']].'"></a>';  
                          }else{
                            $row[$column['name']] = '<a href="javascript:;" >没有图片</a>';
                          }
